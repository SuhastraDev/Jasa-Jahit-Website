                    ...
                    <div class="space-y-3">
                        ...
                        <div class="border border-gray-100 rounded-xl p-4">
                            ...
                            <dl class="grid grid-cols-3 gap-1.5">
                                @foreach([['Lingkar Dada',$m->chest],['Lingkar Pinggang',$m->waist],['Lingkar Pinggul',$m->hips],['Lebar Bahu',$m->shoulder_width],['Panjang Tangan',$m->arm_length],['Tinggi Badan',$m->height]] as [$lbl,$val])
