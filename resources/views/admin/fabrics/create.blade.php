...
<div class="max-w-2xl mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Bahan</h1>
            <p class="text-gray-500 text-sm mt-0.5">Tambahkan jenis bahan baru untuk pilihan pelanggan saat checkout</p>
        </div>
    </div>

    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <form action="{{ route('admin.fabrics.store') }}" method="POST" class="p-6 space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                    placeholder="Contoh: Katun, Linen, Silk, Brokat..."
            ...
            <div>
                ...
                <p class="mt-1.5 text-xs text-gray-400">Menentukan bahan ini akan muncul untuk jenis pakaian kategori apa saat pelanggan checkout.</p>
                @error('category')
                    <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="number" id="price_addition" name="price_addition" value="{{ old('price_addition', 0) }}" required min="0" step="1000"
                    placeholder="0"
                ...
                <p class="mt-1.5 text-xs text-gray-400">Biaya ini ditambahkan di atas harga dasar layanan saat pelanggan memilih bahan ini.</p>
            ...
            <div>
                ...
                <input type="number" id="stock_meters" name="stock_meters" value="{{ old('stock_meters', 0) }}" required min="0" step="0.5"
                    placeholder="0"
